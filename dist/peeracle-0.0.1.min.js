...
d=-1022}return Math.pow(-1,c)*k*Math.pow(2,-52)*Math.pow(2,d)};g.prototype.ea=function(b){var c=0,d=0,e;e=b;switch(e){case Number.POSITIVE_INFINITY:c=2146435072;break;case Number.NEGATIVE_INFINITY:c=4293918720;break;case 0:c=1073741824;break;case -0:c=3221225472;break;default:if(Number.isNaN(b)){c=2146959360;break}-0>=e&&(c=2147483648,e=-e);b=Math.floor(Math.log(e)/Math.log(2));e=Math.floor(e/Math.pow(2,b)*Math.pow(2,52));d=e&4294967295;e/=Math.pow(2,32);b+=1023;2047<=b?(b=2047,e=0):0>b&&(b=0);c=
c|b<<20|e&1048575}this.c(c);this.c(d)};g.prototype.r=function(b){var c=this.L(4),d=(c[0]<<24)+(c[1]<<16)+(c[2]<<8);return b?d+c[3]>>>0:d+c[3]};g.prototype.s=function(b,c){var d=0,e=[],k=b;for(c&&(k>>>=0);4>d;)e[d]=k&255,k>>=8,++d;this.N(new Uint8Array(e.reverse()))};g.prototype.d=function(){return this.r(!0)};g.prototype.c=function(b){this.s(b,!0)};g.prototype.M=function(b){var c="",d,e;if(b){d=this.L(b);for(e=0;e<b;++e)c+=String.fromCharCode(d[e]);return c}for(e=this.F();e;)c+=String.fromCharCode(e),
e=this.F();return c};g.prototype.O=function(b){var c,d,e;d=b.length;e=new Uint8Array(d+1);for(c=0;c<d;++c)e[c]=b.charCodeAt(c);e[d]=0;this.N(e)};g.prototype.seek=function(b){if(b>=this.e)throw new RangeError(g.I);this.a=b};f.Aa=g;l.k=function(b){for(var c in l)if(l.hasOwnProperty(c)&&l[c].hasOwnProperty("IDENTIFIER")&&l[c].T===b)return new l[c];return null};l.prototype.i=function(){};l.prototype.f=function(){};l.prototype.update=function(){};l.prototype.finish=function(){};l.prototype.n=function(){};
